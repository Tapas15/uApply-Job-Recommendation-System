...
# Configure JWT
app.config['JWT_SECRET_KEY'] = os.getenv('JWT_SECRET_KEY', 'uapply-secret-key-2024')
...
try:
    ...
    print(f"Warning: Could not load resources: {str(e)}")
...
def get_recommended_jobs():
    ...
    students = pd.read_csv('../notebooks/students5.csv')
